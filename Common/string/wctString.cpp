...
const char wctString::HexChars[] = {"0123456789ABCDEF"};

// Char Maximum length

const int wctString::BCharMaxlength =  3;  		/**< BChar Max length in string format 		*/
const int wctString::BShortMaxlength =  6;  		/**< BShort Max length in string format 	*/
const int wctString::BIntMaxlength  = 11; 		/**< BInt Max length in string format 		*/
const int wctString::BLongMaxlength =  11; 		/**< BLong Max length in string format 		*/
const int wctString::BLong64Maxlength =  21; 	    /**< BLong64 Max length in string format 	*/

const int wctString::BUCharMaxlength =  3; 		/**< BUChar Max length in string format 	*/
const int wctString::BUShortMaxlength =  5; 		/**< BUShort Max length in string format 	*/
const int wctString::BUIntMaxlength  = 10; 		/**< BUInt Max length in string format 		*/
const int wctString::BULongMaxlength  = 10; 		/**< BULong Max length in string format 	*/
const int wctString::BULong64Maxlength  = 20; 	/**< BULong64 Max length in string format 	*/

const int wctString::BFloatMaxlength  = 15; 		/**< BFloat Max length in string format 	*/
const int wctString::BDoubleMaxlength  = 15; 	    /**< BDouble Max length in string format 	*/
const int wctString::BLDoubleMaxlength =  15; 	/**< BLDouble Max length in string format 	*/

// Maximum value rounded 10 to convert faster to string

const int wctString::BChar10Max  = 2; 			/**< BChar Max length in string format 		*/
const int wctString::BShort10Max  = 4;			/**< BShort Max length in string format 	*/
const int wctString::BIntMax10 =  10;				/**< BInt Max length in string format 		*/
const int wctString::BLongMax10 =  10;			/**< BLong Max length in string format 		*/
const int wctString::BLong6410Max  = 18 ;			/**< BLong64 Max length in string format 	*/

const int wctString::BUChar10Max  = 2;			/**< BUChar Max length in string format 	*/
const int wctString::BUShort10Max =  4;			/**< BUShort Max length in string format 	*/
const int wctString::BUInt10Max =  10;		 	/**< BUInt Max length in string format 		*/
const int wctString::BULong10Max  = 10;		 	/**< BULong Max length in string format 	*/
const int wctString::BULong6410Max =  20; 	    /**< BULong64 Max length in string format 	*/

const int wctString::BFloat10Max  = 20; 		    /**< BFloat Max length in string format 	*/
const int wctString::BDouble10Max =  20; 	        /**< BDouble Max length in string format 	*/
const int wctString::BLDouble10Max =  20;     	/**< BLDouble Max length in string format 	*/
...
// Check buffer size
//----------------------------------
bool wctString::allocateIfNeeded(const int inRequeriedSpace)
{
        if( bufferlength <= inRequeriedSpace + length ){		// If the buffer is too small
                ...
                if(string){
                        wctString::Copy(string , str);					// copy original string
...
bool wctString::allocateIfNeeded(const int inRequeriedSpace)
{
	...
	{		// If the buffer is too small
		...
		if(wstring)
		{
            wctString::Copy(wstring , str);					// copy original string
...
/**
* @brief wctString implementation
* @file wctString.cpp
*/


wctString& wctString::append(const W_CHAR_T * const inString){
        if(!inString) return *this;						// Test if null

        const int sl = wctString::Strlen(inString);		// Check str length

	allocateIfNeeded(sl);

        wctString::Copy(inString,&wstring[length]);	// copy append string
        length += sl;								// calcul new size

	return *this;
}
/*
    wctString& wctString::appendHex(const int& in_value)
    {
...
wctString& wctString::append(const wctString& inString){
        allocateIfNeeded(inString.length);
        wctString::Copy(inString.wstring,&wstring[length]);	// copy append string
...
wctString& wctString::append(const W_CHAR_T in_char){
...
wctString wctString::operator+(const wctString& inString) const
{
        wctString concat(length + inString.length + 1);	// create a string with big buffer

        wctString::Copy(wstring,concat.wstring);
        wctString::Copy(inString.wstring,&concat.wstring[length]);
...
wctString wctString::operator+(const W_CHAR_T* const inString) const
{
        const int stringlength = wctString::Strlen(inString);
        wctString concat(length + stringlength + 1);			// create a string with big buffer

        wctString::Copy(wstring,concat.wstring);				// add currrent string
        wctString::Copy(inString,&concat.wstring[length]);	// add 2nd string
...
W_CHAR_T wctString::operator[](const int in_index) const
{
...
wctString& wctString::operator=(const char * const inString)
{
	initObj();
    ...
    wctString::Copy(inString,wstring);			// copy string
...
wctString& wctString::operator=(const wctString & inString)
{
	initObj();
    ...
    wctString::Copy(inString.wstring,wstring);			// copy string
    length = inString.length;						// save length
	return *this;
}


wctString& wctString::operator=(const W_CHAR_T* const inString)
{
	initObj();
    if(!inString)
	{
    ...
    const int sl = wctString::Strlen(inString);
    if(sl >= bufferlength )
	{
        if(wstring) delete(wstring);
        bufferlength = sl + 1;
    ...
    wctString::Copy(inString,wstring);
    length = sl;
...
bool wctString::operator==(const wctString& inString) const
{
...
bool wctString::operator==(const W_CHAR_T* inString) const
{
        if( length != wctString::Strlen(inString) ||
...
int wctString::Strlen(const W_CHAR_T* const inString){
	int indexString = 0;
        if(inString){
...
#ifdef USE_UNICODE_WCTSTRING
int wctString::Copy(const char* const in_src, W_CHAR_T* const in_dest){
	if(!in_dest) return 0;
	if(!in_src) {
		in_dest[0] = '\0';
		return 0;
...
int wctString::Copy(const W_CHAR_T* const in_src, W_CHAR_T* const in_dest){
	if(!in_dest) return 0;
	if(!in_src) {
		in_dest[0] = '\0';
		return 0;
...
*/
/*
void wctString::ithex(int val, bool hexprefix)
{
    int len = sizeof(val);
	if (hexprefix) len+=2;
	allocateIfNeeded(length+len+1);
 ...
 */
/*
void wctString::ul64thex(ULONG64 val, bool hexprefix)
{
    int len = sizeof(val);
	if (hexprefix) len+=2;
	allocateIfNeeded(length+len+1);
...
void wctString::ucthex(unsigned char val, bool hexprefix)   {WCTSTR_TOHEX(val, hexprefix);}
void wctString::ithex(int val, bool hexprefix)              {WCTSTR_TOHEX(val, hexprefix);}
void wctString::uithex(unsigned int val, bool hexprefix)    {WCTSTR_TOHEX(val, hexprefix);}
void wctString::lthex(long val, bool hexprefix)             {WCTSTR_TOHEX(val, hexprefix);}
void wctString::ulthex(unsigned long val, bool hexprefix)   {WCTSTR_TOHEX(val, hexprefix);}
void wctString::l32thex(LONG32 val, bool hexprefix)         {WCTSTR_TOHEX(val, hexprefix);}
void wctString::ul32thex(ULONG32 val, bool hexprefix)       {WCTSTR_TOHEX(val, hexprefix);}
void wctString::l64thex(LONG64 val, bool hexprefix)         {WCTSTR_TOHEX(val, hexprefix);}
void wctString::ul64thex(ULONG64 val, bool hexprefix)       {WCTSTR_TOHEX(val, hexprefix);}


/*
void wctString::uithex(unsigned int val, bool hexprefix)
{
	int len = sizeof(val);
	if (hexprefix) len+=2;
	allocateIfNeeded(length+len+1);
...
*/
void wctString::bytetbinary(unsigned char val)
{
...
/*
void wctString::ulthex(unsigned long val, bool hexprefix)
{
    int len = sizeof(val);
	if (hexprefix) len+=2;
	allocateIfNeeded(length+len+1);
...
void wctString::ustoa (unsigned short num){
...
* @brief Convert int to char
*/
void wctString::uitoa (unsigned int num){
...
* @brief Convert int to char
*/
void wctString::ulitoa (unsigned long num){
...
*/
void wctString::dtoa (double num){
...
/*wctString operator+(const wctString& in_string1, const wctString& in_string2){
	wctString concat(in_string1.length() + in_string2.length());
